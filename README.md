...
java -DERROR_MESSAGES="Test did not see a new command,Infrastructure Error,Internal Server Error" -DSHOW_TESTS=true -DTIME_RANGE=-1h -DSCOPE=organization -jar errored-tests-1.0-jar-with-dependencies.jar
```
